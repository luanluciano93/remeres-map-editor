...
enum EditorActionID {
	...
	BORDER_EDITOR_LISTBOX,
	BORDER_EDITOR_ADD,
	BORDER_EDITOR_REMOVE,
	BORDER_EDITOR_ITEM_FILTER,
	BORDER_EDITOR_ITEM_LIST,
	BORDER_EDITOR_EDGE_BASE, // IDs EDGE_BASE+1 through EDGE_BASE+12 for edge buttons

	GROUND_BRUSH_EDITOR_LISTBOX = BORDER_EDITOR_EDGE_BASE + 20, // leave room for border edge IDs
	GROUND_BRUSH_EDITOR_ADD,
	GROUND_BRUSH_EDITOR_REMOVE,
	GROUND_BRUSH_EDITOR_ITEM_FILTER,
	GROUND_BRUSH_EDITOR_ITEM_LIST,
	GROUND_BRUSH_EDITOR_ITEMS_LIST,
	GROUND_BRUSH_EDITOR_ITEM_ADD,
	GROUND_BRUSH_EDITOR_ITEM_REMOVE,
	GROUND_BRUSH_EDITOR_BORDERS_LIST,
	GROUND_BRUSH_EDITOR_BORDER_ADD,
	GROUND_BRUSH_EDITOR_BORDER_REMOVE,
	GROUND_BRUSH_EDITOR_FRIEND_ADD,
	GROUND_BRUSH_EDITOR_FRIEND_REMOVE,
};
