...
public:
	...
	virtual bool isSpawnMonster() const {
		return false;
	}
	virtual bool isNpc() const {
		return false;
	}
	virtual bool isSpawnNpc() const {
		return false;
	}
	...
	virtual MonsterBrush* asMonster() {
		return nullptr;
	}
	virtual SpawnMonsterBrush* asSpawnMonster() {
		return nullptr;
	}
	virtual NpcBrush* asNpc() {
		return nullptr;
	}
	virtual SpawnNpcBrush* asSpawnNpc() {
		return nullptr;
	}
